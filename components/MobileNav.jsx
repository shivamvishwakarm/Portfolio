...
export const MobileNav = ({ handleNav }) => {
  return (
    <div className="fixed z-40">
      <Image
        className="cursor-pointer z-40 fixed right-0"
        src={"/menu.svg"}
        width={50}
        height={50}
        onClick={handleNav}
      ...
      <aside className="flex flex-col bg-[#5376CE] items-center h-screen relative w-full">
        ...
        <nav className="flex flex-col justify-center">
          ...
          <div>
            ...
            <NavLink link={"https://drive.google.com/file/d/1YnvRVPBSFeadSKlgB2CvLrmg4GQ3mlKF/view?usp=sharing"} ImgLink={"/cv.svg"} name={"CV"} />
          


            <NavLink link={"mailto:vishwakarmashivam2003@gmail.com"} ImgLink={'/contact.svg'} name={'Contact'} />
